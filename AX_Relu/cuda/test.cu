...
int main() {
    ...
    const cpu::CSRGraph_t csrA = RawGraph2CSR<true>(raw_graph, v_num);
    ...
    cuda::launch_kernel(d_csrA, nnz, d_X, d_Y, v_num, dim, cuda::RunMode::Bench);
    ...
    cpu::gemm_4_AX_Relu(csrA, X, correct_Y, dim, v_num);
